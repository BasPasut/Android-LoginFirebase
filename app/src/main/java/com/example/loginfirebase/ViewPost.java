...
public class ViewPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ViewPost.this,"Please wait, it's loading",Toast.LENGTH_SHORT).show();
    }
    ...
    public void onStart(){
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<ViewSingleItem, ShowDataViewHolder>(ViewSingleItem.class,R.layout.viewsingleitem,ShowDataViewHolder.class,myRef) {
            ...
            protected void populateViewHolder(final ShowDataViewHolder viewHolder, ViewSingleItem model, final int position) {
                ...
                // Click at any row of the list and we will delete that row out of that database
    ...
    public static class ShowDataViewHolder extends RecyclerView.ViewHolder {
        ...
        private void Image_URL(String title) {
            Glide.with(itemView.getContext()).load(title).crossFade().placeholder(R.drawable.googleg_disabled_color_18).thumbnail(01.f).diskCacheStrategy(DiskCacheStrategy.ALL).into(image_url);
        }
    }
}
